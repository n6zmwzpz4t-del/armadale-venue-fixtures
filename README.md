...
The **Refresh Armadale supporter data** workflow runs every 15 minutes on Sundays in Perth time (AWST), at :08, :23, :38 and :53, and hourly at :23 on other days. GitHub may delay scheduled jobs. It saves `reports/supporters.json`, which the public ChatGPT Site fetches on opening and every five minutes while visible. This is a periodically checked feed, not real-time scoring. The Site also carries a fallback snapshot.
